...
fun Activity.makeAccountPublic(message: String, callback: MakeAccountPublicCallback, switchVal: String){
    MaterialDialog(this)
            .show{
                title(R.string.are_you_sure)
                message(text = message)
...
interface MakeAccountPublicCallback{

    fun proceed( switchVal: String)
