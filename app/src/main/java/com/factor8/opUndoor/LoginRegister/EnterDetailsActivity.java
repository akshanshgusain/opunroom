...
import com.factor8.opUndoor.databinding.ActivityEnterDetailsBinding;
...
public class EnterDetailsActivity extends AppCompatActivity implements RestCalls.CheckUsernameI, RestCalls.CheckEmailI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.textViewWorkspaceEmail.setText("@"+bundle.get(ProjectConstants.INTENT_NAME_WORKSPACE).toString().trim()+".com");
    ...
    public void responseEmailCheck(Map<String, String> response) {
        ...
        if(response.get("status").equals("1")){
            ...
            if(emailAvailable){
                ...
                bundle.putString(ProjectConstants.INTENT_EMAIL_WORKSPACE, binding.editTextEmail.getText().toString().trim());
                bundle.putString(ProjectConstants.INTENT_USERNAME_WORKSPACE, binding.editTextUsername.getText().toString().trim());
                bundle.putString(ProjectConstants.INTENT_PASSWORD_WORKSPACE, binding.editTextPassword.getText().toString().trim());
