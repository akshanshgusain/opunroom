...
import org.akshanshgusain.killmonger2test.databinding.ActivitySettingsBinding;
...
public class SettingsActivity extends AppCompatActivity implements RestCalls.UpdateUserProfileI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.editTextFullName.setText(pref.getString(PREF_KEY_F_NAME, "NameDefault"));
        binding.editTextEmail.setText(pref.getString(PREF_KEY_L_NAME, "lastNameDefault"));
        Glide.with(this).load(pref.getString(PREF_KEY_PICTURE, "NameDefault")).into(binding.imageViewUserDisplayPicture);
    ...
    private void getCurrentData() {
        bundle.putString("f_name", pref.getString(PREF_KEY_F_NAME, "1"));
        bundle.putString("l_name", pref.getString(PREF_KEY_L_NAME, "1"));
        bundle.putString("id", pref.getString(PREF_KEY_ID, "1"));
        bundle.putString("username", pref.getString(PREF_KEY_USERNAME, "1"));
        bundle.putString("email", pref.getString(PREF_KEY_EMAIL, "@"));
        bundle.putString("network", pref.getString(PREF_KEY_NETWORK, "1"));
    }
