 ...
 */
public class ApiEmptyResponse<T> : GenericApiResponse<T>()

public data class ApiSuccessResponse<T>(val body: T) : GenericApiResponse<T>() {}

public data class ApiErrorResponse<T>(val errorMessage: String) : GenericApiResponse<T>()