...
abstract class NetworkBoundResource<ResponseObject, ViewStateType>
    ...
    init {
        ...
        if(isNetworkAvailable){
            // IF the network is available then launch 2 parallel coroutines 1. for request and 1 that will simultaneously count the Network timeout
